export function createMap(scene, player) {
  ...
  scene.collideWithMap = function (sprite) {
    scene.physics.add.collider(sprite, ground);
    // scene.physics.add.collider(sprite, leftWall);
    // scene.physics.add.collider(sprite, rightWall);
  };
